          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <section className="px-6 xl:px-0">
              <div className="mx-auto container">
                ...
                <div className="flex items-center justify-center bg-[#113e6e] text-white border border-white w-32 p-2 rounded-md ml-80 mt-6 ">
                  <a href="/login">
                    Get Started
                  </a>
                </div>
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div className="w-full lg:w-6/12">
                    <h2 className="w-full font-bold lg:text-4xl text-[#113e6e] text-3xl lg:leading-10 leading-9 mt-20">We are here to make great design accessible and delightfull for everyone</h2>
            ...
            <div className="relative mt-24">
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                    <div className="z-20 w-12 h-12 bg-[#052646] rounded-full flex justify-center items-center">
                    ...
                    <svg className="z-20" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="24" cy="24" r="24" fill="#052646" />
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    ...
                    <p className="font-normal text-base leading-6 text-[#052646] mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
                <div>
